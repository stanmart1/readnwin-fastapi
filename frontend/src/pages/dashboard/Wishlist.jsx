...
export default function Wishlist() {
  const wishlistItems = [
    { id: 1, title: 'The Hobbit', author: 'J.R.R. Tolkien', price: 24.99, inStock: true },
    { id: 2, title: 'Harry Potter', author: 'J.K. Rowling', price: 29.99, inStock: true },
    { id: 3, title: 'The Lord of the Rings', author: 'J.R.R. Tolkien', price: 34.99, inStock: false },
    { id: 4, title: 'Dune', author: 'Frank Herbert', price: 19.99, inStock: true }
  ];
